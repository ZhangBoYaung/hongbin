 ...
 * @param Shake Effect
 * @text 激活颤动效果
 * @desc 激活颤动效果 false/true
 * @default true 
 *
 * @param HP Number Visible
 * @text 激活数字显血
 * @desc 用数字表示HP false/true
 * @default true
 *
 * @param Show Face
 * @text 显示脸图
 * @desc 显示脸图 false/true
 * @default true
 *
 * @param Slant Animation
 * @text 流量动画
 * @desc 启用“流量”动画 false/true
 * @default true
 *
 * @param Flow Speed
 * @text 流速
 ...
 * @text 百分比血量
 * @desc 以百分比形式 false/true
 * @default false
 *
 * @param Show States
 * @text 显示图标
 * @desc 显示编码图标 false/true
 * @default true
 *
 * @param States Max
 * @text 最大图标数
 ...
 * 要隐藏或显示血量数值插件命令:
 *
 * boss_hp_number_hide  //隐藏
 * boss_hp_number_show  //显示
 * ============================================================================ 
 *              \     /
 *              \\   //
 *               )\-/(
